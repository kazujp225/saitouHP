...
function App() {
  ...
  return (
    <div className="app">
      <nav className="nav">
        <div className="nav-logo">FRF.inc</div>
      ...
      <header className="hero">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 className="giant-text animate-in" style={{ color: '#fff' }}>
            Finest<br />
            Residence<br />
            Factory
          </h1>
          ...
          <div className="search-widget animate-in delay-3">
            ...
            <div className="search-inputs">
              <div className="search-group">
                <label>AREA</label>
                <select><option>エリアを選択</option><option>東京都心</option><option>城南・城西</option></select>
              </div>
              <div className="search-group">
                <label>TYPE</label>
                <select><option>種別を選択</option><option>マンション</option><option>戸建て</option><option>土地</option></select>
              </div>
              <div className="search-group">
                <label>PRICE</label>
                <select><option>予算を選択</option><option>〜5,000万円</option><option>〜1億円</option><option>1億円〜</option></select>
              </div>
      ...
      <section className="section container" id="projects">
        ...
        <div className="split-layout reveal" style={{ marginBottom: '6rem' }}>
          <div className="split-image">
            ...
            <img src="https://images.unsplash.com/photo-1600596542815-3ad19e6e67af?q=80&w=2075&auto=format&fit=crop" alt="Project 1" />
          </div>
          <div className="split-content">
            ...
            <div style={{ marginTop: '2rem' }}>
              <a href="#" className="arrow-link">VIEW DETAILS {'->'}</a>
            </div>
          </div>
        </div>
      ...
      <section className="section container" id="contact" style={{ paddingBottom: '160px' }}>
        <div className="reveal">
          ...
          <div className="contact-actions" style={{ marginTop: '4rem', display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
            <a href="#" className="btn-primary">資料請求 (Request Info)</a>
            <a href="mailto:info@example.com" className="btn-secondary">お問い合わせ (Contact)</a>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <a href="#">Contact</a>
            <a href="#">Facebook</a>
            <a href="#" style={{ marginTop: '1rem', fontSize: '0.8rem' }}>Privacy Policy</a>
          </div>
        </div>
      </footer>
    </div>
...
function ProjectItem({ name, jpName, location, units }) {
  return (
